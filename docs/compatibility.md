...
Current baseline: **1019 accepted / 1802 total; 783 unresolved**.
...
| ENT-ZOMBIE | Zombie definitions and player-observable behavior | 6 | 33 | partial | PRs `#27`, `#83`, `#107`, `#109`, `#111`; runs `29969908209`/`29969908244`/`30141692579`/`30141692532`/`30152116202`/`30152116249`/`30152333302`/`30152333296`/`30152776730`/`30152776724`; Normal, Conehead (640 HP), Flag (270 HP), Buckethead (1370 HP), PoleVaulter (500 HP, vaults over first plant) — all share movement/eat/damage logic with different health values; ignored artifacts/conehead-zombie/verification.md, artifacts/pole-vaulter/verification.md |
