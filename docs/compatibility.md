...
Current baseline: **1022 accepted / 1802 total; 780 unresolved**.
...
| ENT-ZOMBIE | Zombie definitions and player-observable behavior | 8 | 33 | partial | PRs `#27`, `#83`, `#107`, `#109`, `#111`, `#114`, `#117`; runs `29969908209`/`29969908244`/`30141692579`/`30141692532`/`30152116202`/`30152116249`/`30152333302`/`30152333296`/`30152776730`/`30152776724`/`30152983281`/`30152983283`/`30153184493`/`30153184475`; Normal, Conehead, Flag, Buckethead, ScreenDoor, DuckyTube, PoleVaulter; ignored artifacts/conehead-zombie/verification.md, artifacts/pole-vaulter/verification.md, artifacts/screen-door-zombie/verification.md, artifacts/ducky-tube/verification.md |
