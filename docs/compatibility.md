...
Current baseline: **1021 accepted / 1802 total; 781 unresolved**.
...
| ENT-ZOMBIE | Zombie definitions and player-observable behavior | 7 | 33 | partial | PRs `#27`, `#83`, `#107`, `#109`, `#111`, `#114`; runs `29969908209`/`29969908244`/`30141692579`/`30141692532`/`30152116202`/`30152116249`/`30152333302`/`30152333296`/`30152776730`/`30152776724`/`30152983281`/`30152983283`; Normal, Conehead, Flag, Buckethead, ScreenDoor (1370 HP), PoleVaulter — all share movement/eat/damage logic with different health values; ignored artifacts/conehead-zombie/verification.md, artifacts/pole-vaulter/verification.md, artifacts/screen-door-zombie/verification.md |
