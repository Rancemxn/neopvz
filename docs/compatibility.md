...
Current baseline: **1232 accepted / 1809 total; 577 unresolved**.
...
| ENT-EFFECT | Player-observable particle/effect events | 54 | 105 | partial | Ignored `artifacts/effect-evidence/catalog.md` (full 106-entry trigger-site catalog) and `artifacts/effect-anchors/verification.md`; 50 simulation-class effects have deterministic anchor events and focused tests (splats, specials, planting, grave/vase lifecycle, armor/shield drops, thaw, potato arm, tallnut jump block, pogo break, digger rise, mind control, vehicle deaths, ice-trail state); remaining units ride the portal/boss/umbrella/butter systems and the renderer campaign; Issues `#2`, `#5` |
