...
Current baseline: **1009 accepted / 1802 total; 793 unresolved**.
...
| SIM-SYSTEM | Tick ordering, RNG, damage, cooldown, resources, waves, collisions, placement, special rules, pause, win/loss, and restart | 9 | 13 | partial | PRs `#78`, `#81`, `#82`, `#83`, `#84`, `#85`, `#94`, `#98`; runs `30135391025`/`30135391020`/`30137046838`/`30137046837`/`30137384083`/`30137384077`/`30141692579`/`30141692532`/`30142029320`/`30142029344`/`30142326755`/`30142326732`/`30150244061`/`30150244058`/`30151399161`/`30151399179`; core pause-freeze, aquatic-placement, roof-placement, Garlic timing, mower-boundary, terminal-restart, nocturnal-sleep/coffee-wake, zombie-hypnotize, and wave-spawning tests (`first_wave_spawns_on_tick_1800`) with ignored local records |
