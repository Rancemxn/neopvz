...
Current baseline: **1026 accepted / 1802 total; 776 unresolved**.
...
| ENT-ZOMBIE | Zombie definitions and player-observable behavior | 12 | 33 | partial | PRs `#27`, `#83`, `#107`, `#109`, `#111`, `#114`, `#117`, `#119`, `#121`, `#123`, `#125`; runs `29969908209`/`29969908244`/`30141692579`/`30141692532`/`30152116202`/`30152116249`/`30152333302`/`30152333296`/`30152776730`/`30152776724`/`30152983281`/`30152983283`/`30153184493`/`30153184475`/`30153465523`/`30153465528`/`30153750557`/`30153750564`/`30153860072`/`30153860073`/`30154448402`/`30154448405`; Normal, Flag, Conehead, Buckethead, ScreenDoor, DuckyTube, Football (1670 HP, 2.5x speed), Imp (70 HP), Newspaper (540 HP, speed boost after paper destroyed), PoleVaulter, Jackbox (270 HP, 500–1500-tick random detonation, 1800 damage within 115 units across ±1 row, including death-triggered explosion); ignored artifacts/conehead-zombie/verification.md, artifacts/pole-vaulter/verification.md, artifacts/screen-door-zombie/verification.md, artifacts/ducky-tube/verification.md, artifacts/football-zombie/verification.md, artifacts/newspaper-zombie/verification.md, artifacts/imp-zombie/verification.md, artifacts/jackbox-zombie/verification.md; local DEBUG full gate (format, Clippy, workspace tests, and DEBUG workspace build) passed |
