...
Current baseline: **1015 accepted / 1802 total; 787 unresolved**.
...
| ENT-ZOMBIE | Zombie definitions and player-observable behavior | 3 | 33 | partial | PRs `#27`, `#83`, `#107`; runs `29969908209`/`29969908244`/`30141692579`/`30141692532`/`30152116202`/`30152116249`; Normal and Conehead zombie behavior (270/640 HP, same movement/eat/damage); ignored artifacts/conehead-zombie/verification.md |
