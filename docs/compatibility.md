...
| INPUT-ACTION | Mouse, keyboard, hover, click, drag, placement, pause, restart, and command-line resource selection | 3 | 8 | partial | PR `#64`, left-click placement and Space pause/resume in ignored `artifacts/windows-23f3f67/verification.md`; Issue `#17` |
