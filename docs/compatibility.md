...
Current baseline: **956 accepted / 1802 total; 846 unresolved**.
...
| INPUT-ACTION | Mouse, keyboard, hover, click, drag, placement, pause, restart, and command-line resource selection | 2 | 8 | partial | PR `#64`, Enter -> Enter -> Digit2 -> left-click placement in ignored `artifacts/windows-508bb14/verification.md`; Issue `#17` |
