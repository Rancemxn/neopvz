...
Current baseline: **1017 accepted / 1802 total; 785 unresolved**.
...
| ENT-ZOMBIE | Zombie definitions and player-observable behavior | 5 | 33 | partial | PRs `#27`, `#83`, `#107`, `#109`; runs `29969908209`/`29969908244`/`30141692579`/`30141692532`/`30152116202`/`30152116249`/`30152333302`/`30152333296`; Normal, Conehead (640 HP), Flag (270 HP), Buckethead (1370 HP) behavior — all share the same movement/eat/damage logic with different health values; ignored artifacts/conehead-zombie/verification.md |
