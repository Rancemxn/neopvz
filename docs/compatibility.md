...
Current baseline: **936 accepted / 1802 total; 866 unresolved**.
...
|---|---|---:|---:|---|---|
| ENT-PLANT | Plant definitions and player-observable behavior | 16 | 49 | partial | PRs `#27`, `#30`, `#33`, `#36`, `#39`, `#42`, `#44`, `#48`, `#50`, `#53`; runs `29969908209`/`29973097050`/`29973716257`/`29974169417`/`29974744365`/`29975305952`/`29975305940`/`29975652655`/`29975652651`/`29978884187`/`29978884201`/`29979356134`/`29979356138`/`29980230929`/`29980230938`; ignored local source/runtime records |
...
TwinSunflower, CherryBomb, PotatoMine, Jalapeno, IceShroom, DoomShroom,
Wallnut, and Tallnut
behavior; the
normal zombie;
