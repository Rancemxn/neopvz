...
| winit | 0.30 | https://github.com/rust-windowing/winit | v0.30.13 |
...
| rand (with `chacha`) | 0.10 | https://github.com/rust-random/rand | 0.10.2 |
| thiserror | 2.0 | https://github.com/dtolnay/thiserror | 2.0.19 |
| tracing/tracing-subscriber | 0.1/0.3 | https://github.com/tokio-rs/tracing | tracing-0.1.44 / tracing-subscriber-0.3.23 |
...
| clap | 4.6 | https://github.com/clap-rs/clap | v4.6.4 |
